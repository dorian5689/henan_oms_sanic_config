...
import pandas as pd
import pymysql
from LogTools.LogTool import Logger
from Configs.DataBaseConfig import mysql__localhost_config
...
class MySqlCurd(object):
    ...
    def __init__(self):
        self.log = Logger()
        self.config = mysql__localhost_config()
